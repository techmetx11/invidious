...
class Config
  ...
  # Allow access to content only if the user is logged-in
  property private_instance : Bool = false

  # Allow the use of share tokens (which are generated by logged-in users)
  property share_tokens_enabled : Bool = false
